...
function MentorMarkdown({ children }: { children: string }) {
  return (
    <ReactMarkdown
      ...
      components={{
        h1: props => <h1 className="mb-3 mt-5 text-xl font-black leading-8 first:mt-0" {...props} />,
        h2: props => <h2 className="mb-2 mt-5 text-lg font-black leading-7 first:mt-0" {...props} />,
        h3: props => <h3 className="mb-2 mt-4 text-base font-extrabold leading-7 first:mt-0" {...props} />,
        ...
        ul: props => <ul className="my-3 list-disc space-y-1.5 pl-6 marker:text-primary-500" {...props} />,
        ol: props => <ol className="my-3 list-decimal space-y-1.5 pl-6 marker:font-bold marker:text-primary-700" {...props} />,
        li: props => <li className="pl-1 leading-7" {...props} />,
        blockquote: props => <blockquote className="my-4 border-l-4 border-amber-400 bg-amber-50 px-4 py-2 italic text-gray-700" {...props} />,
        hr: props => <hr className="my-5 border-black/10" {...props} />,
