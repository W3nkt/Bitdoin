...
// Shared by the Bookstore Settings page and the Admin profile modal — these
// accounts are the single source of QR/bank details shown to both bookstore
// checkout and Academy subscription payment screens.
