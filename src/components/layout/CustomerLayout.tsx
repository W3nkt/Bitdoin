    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="sticky top-0 z-30 bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center gap-3">
          <Link to="/" className="flex items-center flex-shrink-0" aria-label="Pwen Books home">
            <PwenLogoLockup
              className="gap-0 sm:gap-2"
              markClassName="h-8 w-8"
              textClassName="hidden text-primary-700 sm:block"
              subTextClassName="hidden text-gray-500 sm:block"
            />
          </Link>

          <button
            onClick={() => navigate('/search')}
            className="min-w-0 flex-1 flex items-center gap-2 rounded-xl border border-gray-200 px-3 py-2 text-sm text-gray-400 hover:border-primary-400 transition-colors bg-gray-50"
          >
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1 rounded-lg px-2 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-100"
