        ...
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-white/10">
          ...
          <div className="flex-1 min-w-0">
           ...
           <button
             ...
             title="Sign out"
             aria-label="Sign out"
             className="rounded-lg bg-red-500/15 p-1.5 text-red-300 transition-colors hover:bg-red-500 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-red-300"
           >
